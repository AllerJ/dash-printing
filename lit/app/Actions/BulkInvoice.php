...
class BulkInvoice
{
    ...
    public function run(Collection $models)
    {
        ...
        foreach($models as $post){
                ...
                $total_tax = floatval($post->tax_1) + floatval($post->tax_2);
        ...
        $number_of_items = count($models);
        return response()->success('Invoice Created and all '. $number_of_items .' projects added to it.');
    }
